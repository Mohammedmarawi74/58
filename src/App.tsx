            ...
            {slide.badgeImage ? (
              ...
              <div className="relative p-[1px] border border-dashed border-gray-500/50">
                ...
                <div className={cn('flex min-h-24 items-stretch', theme.badgeBg)}>
                  ...
                  <div className="flex min-w-max flex-1 flex-col justify-center items-start px-6 py-3">
                    <span className={cn('block whitespace-nowrap text-2xl font-bold tracking-wide', theme.badgeTextColor)}>
                      {slide.badgeMiddle}
                    </span>
                    <div className="mt-1 max-w-full rounded-sm bg-white px-2 py-1 text-xs font-bold text-gray-900 text-bounded" dir="ltr">
                      {slide.badgeBottom}
                    </div>
                  </div>
                </div>
        ...
        <div className="pt-8">
          ...
          <div className={cn('modern-footer flex items-end justify-between gap-6 px-4', theme.textColor)}>
            ...
            <div className="w-[40%] flex-none text-left" dir="ltr">
              <span className="footer-text-glow block text-3xl font-bold tracking-tight opacity-90 transition-opacity text-bounded">
                {slide.footerLeft}
              </span>
            </div>
          </div>
